...
namespace WeiboSDK
{
    ...
    /// 符合TOP习惯的纯字符串字典结构。
    /// </summary>
    public class WeiboDictionary : Dictionary<string, string>
    {
        const string DATE_TIME_FORMAT = "yyyy-MM-dd HH:mm:ss";

        public WeiboDictionary()
        {
        }

        public WeiboDictionary(IDictionary<string, string> dictionary) : base(dictionary)
        {
        }
